...
void drawMap(Point obstacles[], int obstacleCount) {
    system("cls");
...
void generateObstacles(Point obstacles[], int count) {
    srand(time(NULL));
...
int main(int argc, char *argv[]) {
    ...
    writeToDocument("The player starts the game, gamemode: Expert.");
    ...
    initialize(&snake);
    generateFood(&food);
    generateObstacles(obstacles, OBSTACLE_COUNT);

    drawMap(obstacles, OBSTACLE_COUNT);
    drawSnake(&snake);
    drawFood(&food);
